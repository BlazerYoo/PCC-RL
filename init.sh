...
echo ipython==7.20.0 >> requirements.txt
...
echo numpy==1.20.1 >> requirements.txt
...
echo pandas==1.2.2 >> requirements.txt
...
echo scipy==1.6.0 >> requirements.txt
...
echo traitlets==5.0.5 >> requirements.txt
